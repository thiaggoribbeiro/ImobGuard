      ...
      <div className="w-full max-w-[380px] flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-5 w-full" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex w-full items-center gap-3 rounded-xl border border-slate-300 bg-white px-4 h-14 shadow-sm focus-within:border-primary transition-all">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600 flex items-center justify-center transition-colors"
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 w-full bg-primary hover:bg-orange-700 disabled:bg-orange-400 active:scale-[0.98] text-white font-bold h-14 rounded-xl shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-2 text-base"
          >
            {loading ? (
              <>
